...
\begin{enumerate}[noitemsep]
    \item \textbf{Literature Review and Problem Definition}: Survey recent work on deep learning-based AMC, SNR-aware models, and mixture-of-experts architectures to refine the exact SNR ranges, modulations, and channel models to be considered.
...
% Test change: minor edit added for git push and compile verification
